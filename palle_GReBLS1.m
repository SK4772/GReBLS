function [] = palle_GReBLS1(name,num)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%参数设置%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
N1=randi([35,50],1,1);%feature nodes  per window
Ng=randi([40,55],1,1);
N2=randi([2500,4000],1,1);% number of enhancement nodes
...
lambda=lambdaE(M(1));
gamma=gammaF(N(1));
save ( ['YaleB_0b\Result_' char(name) '_train' num2str(select_num) '_' num2str(accuracy) '_' num2str(N1) '_' num2str(N2) '_' num2str(Ng) '.mat'], 'accuracy', 'lambda', 'gamma', 'rate_acc','N1','N2','Ng');
clc
clear
close all
end
